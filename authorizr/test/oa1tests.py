...
from oa1test_settings import TWITTER_ACCESS_TOKEN, TWITTER_ACCESS_TOKEN_SECRET
from oa1test_settings import TWITTER_CONSUMER_KEY, TWITTER_CONSUMER_SECRET
